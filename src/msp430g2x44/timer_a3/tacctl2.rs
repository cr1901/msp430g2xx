#[doc = "Register `TACCTL2` reader"]
pub type R = crate::R<TACCTL2_SPEC>;
#[doc = "Register `TACCTL2` writer"]
pub type W = crate::W<TACCTL2_SPEC>;
...
impl W {
    #[doc = "Bit 0 - Capture/compare interrupt flag"]
    #[inline(always)]
    pub fn ccifg(&mut self) -> CCIFG_W<TACCTL2_SPEC> {
        CCIFG_W::new(self, 0)
    }
    #[doc = "Bit 1 - Capture/compare overflow flag"]
    #[inline(always)]
    pub fn cov(&mut self) -> COV_W<TACCTL2_SPEC> {
        COV_W::new(self, 1)
    }
    #[doc = "Bit 2 - PWM Output signal if output mode 0"]
    #[inline(always)]
    pub fn out(&mut self) -> OUT_W<TACCTL2_SPEC> {
        OUT_W::new(self, 2)
    }
    #[doc = "Bit 3 - Capture input signal (read)"]
    #[inline(always)]
    pub fn cci(&mut self) -> CCI_W<TACCTL2_SPEC> {
        CCI_W::new(self, 3)
    }
    #[doc = "Bit 4 - Capture/compare interrupt enable"]
    #[inline(always)]
    pub fn ccie(&mut self) -> CCIE_W<TACCTL2_SPEC> {
        CCIE_W::new(self, 4)
    }
    #[doc = "Bits 5:7 - Output mode 2"]
    #[inline(always)]
    pub fn outmod(&mut self) -> OUTMOD_W<TACCTL2_SPEC> {
        OUTMOD_W::new(self, 5)
    }
    #[doc = "Bit 8 - Capture mode: 1 /Compare mode : 0"]
    #[inline(always)]
    pub fn cap(&mut self) -> CAP_W<TACCTL2_SPEC> {
        CAP_W::new(self, 8)
    }
    #[doc = "Bit 10 - Latched capture signal (read)"]
    #[inline(always)]
    pub fn scci(&mut self) -> SCCI_W<TACCTL2_SPEC> {
        SCCI_W::new(self, 10)
    }
    #[doc = "Bit 11 - Capture sychronize"]
    #[inline(always)]
    pub fn scs(&mut self) -> SCS_W<TACCTL2_SPEC> {
        SCS_W::new(self, 11)
    }
    #[doc = "Bits 12:13 - Capture input select 1"]
    #[inline(always)]
    pub fn ccis(&mut self) -> CCIS_W<TACCTL2_SPEC> {
        CCIS_W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Capture mode 1"]
    #[inline(always)]
    pub fn cm(&mut self) -> CM_W<TACCTL2_SPEC> {
        CM_W::new(self, 14)
    }
}
#[doc = "Timer A Capture/Compare Control 2\n\nYou can [`read`](crate::Reg::read) this register and get [`tacctl2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tacctl2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TACCTL2_SPEC;
impl crate::RegisterSpec for TACCTL2_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [`tacctl2::R`](R) reader structure"]
impl crate::Readable for TACCTL2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`tacctl2::W`](W) writer structure"]
impl crate::Writable for TACCTL2_SPEC {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets TACCTL2 to value 0"]
impl crate::Resettable for TACCTL2_SPEC {
