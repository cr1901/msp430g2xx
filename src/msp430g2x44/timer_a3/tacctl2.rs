...
pub type R = crate::R<Tacctl2Spec>;
#[doc = "Register `TACCTL2` writer"]
pub type W = crate::W<Tacctl2Spec>;
...
impl W {
    #[doc = "Bit 0 - Capture/compare interrupt flag"]
    #[inline(always)]
    pub fn ccifg(&mut self) -> CcifgW<Tacctl2Spec> {
        CcifgW::new(self, 0)
    }
    #[doc = "Bit 1 - Capture/compare overflow flag"]
    #[inline(always)]
    pub fn cov(&mut self) -> CovW<Tacctl2Spec> {
        CovW::new(self, 1)
    }
    #[doc = "Bit 2 - PWM Output signal if output mode 0"]
    #[inline(always)]
    pub fn out(&mut self) -> OutW<Tacctl2Spec> {
        OutW::new(self, 2)
    }
    #[doc = "Bit 3 - Capture input signal (read)"]
    #[inline(always)]
    pub fn cci(&mut self) -> CciW<Tacctl2Spec> {
        CciW::new(self, 3)
    }
    #[doc = "Bit 4 - Capture/compare interrupt enable"]
    #[inline(always)]
    pub fn ccie(&mut self) -> CcieW<Tacctl2Spec> {
        CcieW::new(self, 4)
    }
    #[doc = "Bits 5:7 - Output mode 2"]
    #[inline(always)]
    pub fn outmod(&mut self) -> OutmodW<Tacctl2Spec> {
        OutmodW::new(self, 5)
    }
    #[doc = "Bit 8 - Capture mode: 1 /Compare mode : 0"]
    #[inline(always)]
    pub fn cap(&mut self) -> CapW<Tacctl2Spec> {
        CapW::new(self, 8)
    }
    #[doc = "Bit 10 - Latched capture signal (read)"]
    #[inline(always)]
    pub fn scci(&mut self) -> ScciW<Tacctl2Spec> {
        ScciW::new(self, 10)
    }
    #[doc = "Bit 11 - Capture sychronize"]
    #[inline(always)]
    pub fn scs(&mut self) -> ScsW<Tacctl2Spec> {
        ScsW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Capture input select 1"]
    #[inline(always)]
    pub fn ccis(&mut self) -> CcisW<Tacctl2Spec> {
        CcisW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Capture mode 1"]
    #[inline(always)]
    pub fn cm(&mut self) -> CmW<Tacctl2Spec> {
        CmW::new(self, 14)
    }
}
...
pub struct Tacctl2Spec;
impl crate::RegisterSpec for Tacctl2Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`tacctl2::R`](R) reader structure"]
impl crate::Readable for Tacctl2Spec {}
#[doc = "`write(|w| ..)` method takes [`tacctl2::W`](W) writer structure"]
impl crate::Writable for Tacctl2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets TACCTL2 to value 0"]
impl crate::Resettable for Tacctl2Spec {
