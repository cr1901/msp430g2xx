...
impl R {
    ...
    pub fn eei(&self) -> EeiR {
        EeiR::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Enable Emergency Interrupt Exit"]
    #[inline(always)]
    pub fn eeiex(&self) -> EeiexR {
        EeiexR::new(((self.bits >> 4) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 3 - Enable Erase Interrupts"]
    #[inline(always)]
    pub fn eei(&mut self) -> EeiW<Fctl1Spec> {
        EeiW::new(self, 3)
    }
    #[doc = "Bit 4 - Enable Emergency Interrupt Exit"]
    #[inline(always)]
    pub fn eeiex(&mut self) -> EeiexW<Fctl1Spec> {
        EeiexW::new(self, 4)
    }
    #[doc = "Bit 6 - Enable bit for Flash write"]
    #[inline(always)]
