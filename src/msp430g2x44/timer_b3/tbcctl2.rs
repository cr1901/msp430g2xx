...
pub type R = crate::R<Tbcctl2Spec>;
#[doc = "Register `TBCCTL2` writer"]
pub type W = crate::W<Tbcctl2Spec>;
...
impl W {
    #[doc = "Bit 0 - Capture/compare interrupt flag"]
    #[inline(always)]
    pub fn ccifg(&mut self) -> CcifgW<Tbcctl2Spec> {
        CcifgW::new(self, 0)
    }
    #[doc = "Bit 1 - Capture/compare overflow flag"]
    #[inline(always)]
    pub fn cov(&mut self) -> CovW<Tbcctl2Spec> {
        CovW::new(self, 1)
    }
    #[doc = "Bit 2 - PWM Output signal if output mode 0"]
    #[inline(always)]
    pub fn out(&mut self) -> OutW<Tbcctl2Spec> {
        OutW::new(self, 2)
    }
    #[doc = "Bit 3 - Capture input signal (read)"]
    #[inline(always)]
    pub fn cci(&mut self) -> CciW<Tbcctl2Spec> {
        CciW::new(self, 3)
    }
    #[doc = "Bit 4 - Capture/compare interrupt enable"]
    #[inline(always)]
    pub fn ccie(&mut self) -> CcieW<Tbcctl2Spec> {
        CcieW::new(self, 4)
    }
    #[doc = "Bits 5:7 - Output mode 2"]
    #[inline(always)]
    pub fn outmod(&mut self) -> OutmodW<Tbcctl2Spec> {
        OutmodW::new(self, 5)
    }
    #[doc = "Bit 8 - Capture mode: 1 /Compare mode : 0"]
    #[inline(always)]
    pub fn cap(&mut self) -> CapW<Tbcctl2Spec> {
        CapW::new(self, 8)
    }
    #[doc = "Bits 9:10 - Compare latch load source 1"]
    #[inline(always)]
    pub fn clld(&mut self) -> ClldW<Tbcctl2Spec> {
        ClldW::new(self, 9)
    }
    #[doc = "Bit 11 - Capture sychronize"]
    #[inline(always)]
    pub fn scs(&mut self) -> ScsW<Tbcctl2Spec> {
        ScsW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Capture input select 1"]
    #[inline(always)]
    pub fn ccis(&mut self) -> CcisW<Tbcctl2Spec> {
        CcisW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Capture mode 1"]
    #[inline(always)]
    pub fn cm(&mut self) -> CmW<Tbcctl2Spec> {
        CmW::new(self, 14)
    }
}
...
pub struct Tbcctl2Spec;
impl crate::RegisterSpec for Tbcctl2Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`tbcctl2::R`](R) reader structure"]
impl crate::Readable for Tbcctl2Spec {}
#[doc = "`write(|w| ..)` method takes [`tbcctl2::W`](W) writer structure"]
impl crate::Writable for Tbcctl2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets TBCCTL2 to value 0"]
impl crate::Resettable for Tbcctl2Spec {
