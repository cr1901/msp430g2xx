...
pub type P3selR = crate::FieldReader;
#[doc = "Field `P3SEL` writer - Port 3 Selection register"]
pub type P3selW<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
...
impl R {
    ...
    #[inline(always)]
    pub fn p3sel(&self) -> P3selR {
        P3selR::new(self.bits)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
    pub fn p1(&self) -> P1R {
...
impl W {
    #[doc = "Bit 0 - P0"]
    #[inline(always)]
    pub fn p0(&mut self) -> P0W<P3selSpec> {
        P0W::new(self, 0)
    }
    #[doc = "Bits 0:7 - Port 3 Selection register"]
    #[inline(always)]
    pub fn p3sel(&mut self) -> P3selW<P3selSpec> {
        P3selW::new(self, 0)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
    pub fn p1(&mut self) -> P1W<P3selSpec> {
        P1W::new(self, 1)
    }
    #[doc = "Bit 2 - P2"]
    #[inline(always)]
    pub fn p2(&mut self) -> P2W<P3selSpec> {
        P2W::new(self, 2)
    }
    #[doc = "Bit 3 - P3"]
    #[inline(always)]
    pub fn p3(&mut self) -> P3W<P3selSpec> {
        P3W::new(self, 3)
    }
    #[doc = "Bit 4 - P4"]
    #[inline(always)]
    pub fn p4(&mut self) -> P4W<P3selSpec> {
        P4W::new(self, 4)
    }
    #[doc = "Bit 5 - P5"]
    #[inline(always)]
    pub fn p5(&mut self) -> P5W<P3selSpec> {
        P5W::new(self, 5)
    }
    #[doc = "Bit 6 - P6"]
    #[inline(always)]
    pub fn p6(&mut self) -> P6W<P3selSpec> {
        P6W::new(self, 6)
    }
    #[doc = "Bit 7 - P7"]
    #[inline(always)]
    pub fn p7(&mut self) -> P7W<P3selSpec> {
        P7W::new(self, 7)
    }
}
