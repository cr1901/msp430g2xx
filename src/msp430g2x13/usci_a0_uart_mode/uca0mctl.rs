...
pub type R = crate::R<UCA0MCTL_SPEC>;
#[doc = "Register `UCA0MCTL` writer"]
pub type W = crate::W<UCA0MCTL_SPEC>;
...
pub type UCBRS_W<'a, REG> = crate::FieldWriter<'a, REG, 3, UCBRS_A, crate::Safe>;
...
pub type UCBRF_W<'a, REG> = crate::FieldWriter<'a, REG, 4, UCBRF_A, crate::Safe>;
...
impl W {
    #[doc = "Bit 0 - USCI 16-times Oversampling enable"]
    #[inline(always)]
    pub fn ucos16(&mut self) -> UCOS16_W<UCA0MCTL_SPEC> {
        UCOS16_W::new(self, 0)
    }
    #[doc = "Bits 1:3 - USCI Second Stage Modulation Select 2"]
    #[inline(always)]
    pub fn ucbrs(&mut self) -> UCBRS_W<UCA0MCTL_SPEC> {
        UCBRS_W::new(self, 1)
    }
    #[doc = "Bits 4:7 - USCI First Stage Modulation Select 3"]
    #[inline(always)]
    pub fn ucbrf(&mut self) -> UCBRF_W<UCA0MCTL_SPEC> {
        UCBRF_W::new(self, 4)
    }
}
