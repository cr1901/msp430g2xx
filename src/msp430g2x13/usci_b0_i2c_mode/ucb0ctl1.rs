...
impl W {
    ...
    #[doc = "Bit 1 - Transmit START"]
    #[inline(always)]
    pub fn uctxstt(&mut self) -> UCTXSTT_W<UCB0CTL1_SPEC> {
        UCTXSTT_W::new(self, 1)
    }
    #[doc = "Bit 2 - Transmit STOP"]
    #[inline(always)]
    pub fn uctxstp(&mut self) -> UCTXSTP_W<UCB0CTL1_SPEC> {
        UCTXSTP_W::new(self, 2)
    }
    #[doc = "Bit 3 - Transmit NACK"]
    #[inline(always)]
    pub fn uctxnack(&mut self) -> UCTXNACK_W<UCB0CTL1_SPEC> {
        UCTXNACK_W::new(self, 3)
    }
    #[doc = "Bit 4 - Transmit/Receive Select/Flag"]
    #[inline(always)]
    pub fn uctr(&mut self) -> UCTR_W<UCB0CTL1_SPEC> {
        UCTR_W::new(self, 4)
    }
    #[doc = "Bits 6:7 - USCI 1 Clock Source Select 1"]
    #[inline(always)]
