...
pub type ADC10SC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type ADC10IFG_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type REF2_5V_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type REFBURST_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type ADC10SR_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl crate::IsEnum for ADC10SHT_A {}
...
pub type ADC10SHT_W<'a, REG> = crate::FieldWriter<'a, REG, 2, ADC10SHT_A, crate::Safe>;
impl<'a, REG> ADC10SHT_W<'a, REG>
where
...
pub type SREF_W<'a, REG> = crate::FieldWriter<'a, REG, 3, SREF_A, crate::Safe>;
impl<'a, REG> SREF_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    #[doc = "Bit 0 - ADC10 Start Conversion"]
    #[inline(always)]
    pub fn adc10sc(&mut self) -> ADC10SC_W<ADC10CTL0_SPEC> {
        ADC10SC_W::new(self, 0)
    }
    #[doc = "Bit 1 - ADC10 Enable Conversion"]
    #[inline(always)]
    pub fn enc(&mut self) -> ENC_W<ADC10CTL0_SPEC> {
        ENC_W::new(self, 1)
    }
    #[doc = "Bit 2 - ADC10 Interrupt Flag"]
    #[inline(always)]
    pub fn adc10ifg(&mut self) -> ADC10IFG_W<ADC10CTL0_SPEC> {
        ADC10IFG_W::new(self, 2)
    }
    #[doc = "Bit 3 - ADC10 Interrupt Enalbe"]
    #[inline(always)]
    pub fn adc10ie(&mut self) -> ADC10IE_W<ADC10CTL0_SPEC> {
        ADC10IE_W::new(self, 3)
    }
    #[doc = "Bit 4 - ADC10 On/Enable"]
    #[inline(always)]
    pub fn adc10on(&mut self) -> ADC10ON_W<ADC10CTL0_SPEC> {
        ADC10ON_W::new(self, 4)
    }
    #[doc = "Bit 5 - ADC10 Reference on"]
    #[inline(always)]
    pub fn refon(&mut self) -> REFON_W<ADC10CTL0_SPEC> {
        REFON_W::new(self, 5)
    }
    #[doc = "Bit 6 - ADC10 Ref 0:1.5V / 1:2.5V"]
    #[inline(always)]
    pub fn ref2_5v(&mut self) -> REF2_5V_W<ADC10CTL0_SPEC> {
        REF2_5V_W::new(self, 6)
    }
    #[doc = "Bit 7 - ADC10 Multiple SampleConversion"]
    #[inline(always)]
    pub fn msc(&mut self) -> MSC_W<ADC10CTL0_SPEC> {
        MSC_W::new(self, 7)
    }
    #[doc = "Bit 8 - ADC10 Reference Burst Mode"]
    #[inline(always)]
    pub fn refburst(&mut self) -> REFBURST_W<ADC10CTL0_SPEC> {
        REFBURST_W::new(self, 8)
    }
    #[doc = "Bit 9 - ADC10 Enalbe output of Ref."]
    #[inline(always)]
    pub fn refout(&mut self) -> REFOUT_W<ADC10CTL0_SPEC> {
        REFOUT_W::new(self, 9)
    }
    #[doc = "Bit 10 - ADC10 Sampling Rate 0:200ksps / 1:50ksps"]
    #[inline(always)]
    pub fn adc10sr(&mut self) -> ADC10SR_W<ADC10CTL0_SPEC> {
        ADC10SR_W::new(self, 10)
    }
    #[doc = "Bits 11:12 - ADC10 Sample Hold Select Bit: 0"]
    #[inline(always)]
    pub fn adc10sht(&mut self) -> ADC10SHT_W<ADC10CTL0_SPEC> {
        ADC10SHT_W::new(self, 11)
    }
    #[doc = "Bits 13:15 - ADC10 Reference Select Bit: 0"]
    #[inline(always)]
    pub fn sref(&mut self) -> SREF_W<ADC10CTL0_SPEC> {
        SREF_W::new(self, 13)
    }
}
