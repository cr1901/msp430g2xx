...
pub type R = crate::R<P1SEL2_SPEC>;
#[doc = "Register `P1SEL2` writer"]
pub type W = crate::W<P1SEL2_SPEC>;
...
pub type P1SEL2_R = crate::FieldReader;
#[doc = "Field `P1SEL2` writer - Port 1 Selection register 2"]
pub type P1SEL2_W<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
...
impl W {
    #[doc = "Bit 0 - P0"]
    #[inline(always)]
    pub fn p0(&mut self) -> P0_W<P1SEL2_SPEC> {
        P0_W::new(self, 0)
    }
    #[doc = "Bits 0:7 - Port 1 Selection register 2"]
    #[inline(always)]
    pub fn p1sel2(&mut self) -> P1SEL2_W<P1SEL2_SPEC> {
        P1SEL2_W::new(self, 0)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
    pub fn p1(&mut self) -> P1_W<P1SEL2_SPEC> {
        P1_W::new(self, 1)
    }
    #[doc = "Bit 2 - P2"]
    #[inline(always)]
    pub fn p2(&mut self) -> P2_W<P1SEL2_SPEC> {
        P2_W::new(self, 2)
    }
    #[doc = "Bit 3 - P3"]
    #[inline(always)]
    pub fn p3(&mut self) -> P3_W<P1SEL2_SPEC> {
        P3_W::new(self, 3)
    }
    #[doc = "Bit 4 - P4"]
    #[inline(always)]
    pub fn p4(&mut self) -> P4_W<P1SEL2_SPEC> {
        P4_W::new(self, 4)
    }
    #[doc = "Bit 5 - P5"]
    #[inline(always)]
    pub fn p5(&mut self) -> P5_W<P1SEL2_SPEC> {
        P5_W::new(self, 5)
    }
    #[doc = "Bit 6 - P6"]
    #[inline(always)]
    pub fn p6(&mut self) -> P6_W<P1SEL2_SPEC> {
        P6_W::new(self, 6)
    }
    #[doc = "Bit 7 - P7"]
    #[inline(always)]
    pub fn p7(&mut self) -> P7_W<P1SEL2_SPEC> {
        P7_W::new(self, 7)
    }
}
...
pub struct P1SEL2_SPEC;
impl crate::RegisterSpec for P1SEL2_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`p1sel2::R`](R) reader structure"]
impl crate::Readable for P1SEL2_SPEC {}
#[doc = "`write(|w| ..)` method takes [`p1sel2::W`](W) writer structure"]
impl crate::Writable for P1SEL2_SPEC {
    type Safety = crate::Safe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets P1SEL2 to value 0"]
impl crate::Resettable for P1SEL2_SPEC {
