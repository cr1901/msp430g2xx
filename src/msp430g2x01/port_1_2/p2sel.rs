...
pub type P2selR = crate::FieldReader;
#[doc = "Field `P2SEL` writer - Port 2 Selection register"]
pub type P2selW<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
...
impl R {
    ...
    #[inline(always)]
    pub fn p2sel(&self) -> P2selR {
        P2selR::new(self.bits)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
    pub fn p1(&self) -> P1R {
...
impl W {
    #[doc = "Bit 0 - P0"]
    #[inline(always)]
    pub fn p0(&mut self) -> P0W<P2selSpec> {
        P0W::new(self, 0)
    }
    #[doc = "Bits 0:7 - Port 2 Selection register"]
    #[inline(always)]
    pub fn p2sel(&mut self) -> P2selW<P2selSpec> {
        P2selW::new(self, 0)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
    pub fn p1(&mut self) -> P1W<P2selSpec> {
        P1W::new(self, 1)
    }
    #[doc = "Bit 2 - P2"]
    #[inline(always)]
    pub fn p2(&mut self) -> P2W<P2selSpec> {
        P2W::new(self, 2)
    }
    #[doc = "Bit 3 - P3"]
    #[inline(always)]
    pub fn p3(&mut self) -> P3W<P2selSpec> {
        P3W::new(self, 3)
    }
    #[doc = "Bit 4 - P4"]
    #[inline(always)]
    pub fn p4(&mut self) -> P4W<P2selSpec> {
        P4W::new(self, 4)
    }
    #[doc = "Bit 5 - P5"]
    #[inline(always)]
    pub fn p5(&mut self) -> P5W<P2selSpec> {
        P5W::new(self, 5)
    }
    #[doc = "Bit 6 - P6"]
    #[inline(always)]
    pub fn p6(&mut self) -> P6W<P2selSpec> {
        P6W::new(self, 6)
    }
    #[doc = "Bit 7 - P7"]
    #[inline(always)]
    pub fn p7(&mut self) -> P7W<P2selSpec> {
        P7W::new(self, 7)
    }
}
