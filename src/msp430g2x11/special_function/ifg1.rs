...
impl W {
    #[doc = "Bit 0 - Watchdog Interrupt Flag"]
    #[inline(always)]
    pub fn wdtifg(&mut self) -> WdtifgW<Ifg1Spec> {
        WdtifgW::new(self, 0)
    }
    #[doc = "Bit 1 - Osc. Fault Interrupt Flag"]
    #[inline(always)]
    pub fn ofifg(&mut self) -> OfifgW<Ifg1Spec> {
        OfifgW::new(self, 1)
    }
    #[doc = "Bit 2 - Power On Interrupt Flag"]
    #[inline(always)]
    pub fn porifg(&mut self) -> PorifgW<Ifg1Spec> {
        PorifgW::new(self, 2)
    }
    #[doc = "Bit 3 - Reset Interrupt Flag"]
    #[inline(always)]
    pub fn rstifg(&mut self) -> RstifgW<Ifg1Spec> {
        RstifgW::new(self, 3)
    }
    #[doc = "Bit 4 - NMI Interrupt Flag"]
    #[inline(always)]
    pub fn nmiifg(&mut self) -> NmiifgW<Ifg1Spec> {
        NmiifgW::new(self, 4)
    }
}
