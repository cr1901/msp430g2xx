...
pub type R = crate::R<P4sel2Spec>;
#[doc = "Register `P4SEL2` writer"]
pub type W = crate::W<P4sel2Spec>;
...
impl W {
    #[doc = "Bit 0 - P0"]
    #[inline(always)]
    pub fn p0(&mut self) -> P0W<P4sel2Spec> {
        P0W::new(self, 0)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
    pub fn p1(&mut self) -> P1W<P4sel2Spec> {
        P1W::new(self, 1)
    }
    #[doc = "Bit 2 - P2"]
    #[inline(always)]
    pub fn p2(&mut self) -> P2W<P4sel2Spec> {
        P2W::new(self, 2)
    }
    #[doc = "Bit 3 - P3"]
    #[inline(always)]
    pub fn p3(&mut self) -> P3W<P4sel2Spec> {
        P3W::new(self, 3)
    }
    #[doc = "Bit 4 - P4"]
    #[inline(always)]
    pub fn p4(&mut self) -> P4W<P4sel2Spec> {
        P4W::new(self, 4)
    }
    #[doc = "Bit 5 - P5"]
    #[inline(always)]
    pub fn p5(&mut self) -> P5W<P4sel2Spec> {
        P5W::new(self, 5)
    }
    #[doc = "Bit 6 - P6"]
    #[inline(always)]
    pub fn p6(&mut self) -> P6W<P4sel2Spec> {
        P6W::new(self, 6)
    }
    #[doc = "Bit 7 - P7"]
    #[inline(always)]
    pub fn p7(&mut self) -> P7W<P4sel2Spec> {
        P7W::new(self, 7)
    }
}
...
pub struct P4sel2Spec;
impl crate::RegisterSpec for P4sel2Spec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`p4sel2::R`](R) reader structure"]
impl crate::Readable for P4sel2Spec {}
#[doc = "`write(|w| ..)` method takes [`p4sel2::W`](W) writer structure"]
impl crate::Writable for P4sel2Spec {
    type Safety = crate::Safe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets P4SEL2 to value 0"]
impl crate::Resettable for P4sel2Spec {
