...
pub type TBCCR0_R = crate::FieldReader<u16>;
#[doc = "Field `TBCCR0` writer - Timer B Capture/Compare register 0"]
pub type TBCCR0_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16, crate::Safe>;
impl R {
    #[doc = "Bits 0:15 - Timer B Capture/Compare register 0"]
    #[inline(always)]
    pub fn tbccr0(&self) -> TBCCR0_R {
        TBCCR0_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:15 - Timer B Capture/Compare register 0"]
    #[inline(always)]
    pub fn tbccr0(&mut self) -> TBCCR0_W<TBCCR0_SPEC> {
        TBCCR0_W::new(self, 0)
    }
}
