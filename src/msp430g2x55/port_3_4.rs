...
impl RegisterBlock {
    ...
    #[doc = "0x34 - Port 4 Selection 2"]
    #[inline(always)]
    pub const fn p4sel2(&self) -> &P4SEL2 {
        &self.p4sel2
    }
}
...
pub mod p3sel2;
#[doc = "P4SEL2 (rw) register accessor: Port 4 Selection 2\n\nYou can [`read`](crate::Reg::read) this register and get [`p4sel2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p4sel2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@p4sel2`]
module"]
pub type P4SEL2 = crate::Reg<p4sel2::P4SEL2_SPEC>;
