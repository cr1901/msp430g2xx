...
impl core::fmt::Debug for TimerB3 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TimerB3").finish()
    }
}
#[doc = "Timer B3"]
pub mod timer_b3;
