#![doc = "Peripheral access API for MSP430G2X55 microcontrollers (generated using svd2rust v0.34.0 (74eee32 2024-11-11))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
#[repr(u16)]
pub enum Interrupt {
    #[doc = "0 - 0xFFE0 Timer1_A CC1-4, TA1"]
    TIMER1_A1 = 0,
    #[doc = "1 - 0xFFE2 Timer1_A CC0"]
    TIMER1_A0 = 1,
    #[doc = "2 - 0xFFE4 Port 1"]
    PORT1 = 2,
    #[doc = "3 - 0xFFE6 Port 2"]
    PORT2 = 3,
    #[doc = "4 - 0xFFE8 TRAPINT"]
    TRAPINT = 4,
    #[doc = "5 - 0xFFEA ADC10"]
    ADC10 = 5,
    ...
    COMPARATORA = 11,
    #[doc = "12 - 0xFFF8 Timer B CC1-6, TB"]
    TIMERB1 = 12,
    #[doc = "13 - 0xFFFA Timer B CC0"]
    TIMERB0 = 13,
...
impl TIMER1_A3 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const timer0_a3::RegisterBlock = 0x011c as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const timer0_a3::RegisterBlock {
        Self::PTR
...
unsafe impl Send for TIMER_B3 {}
impl TIMER_B3 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const timer_b3::RegisterBlock = 0x011e as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const timer_b3::RegisterBlock {
        Self::PTR
    }
    #[doc = r" Steal an instance of this peripheral"]
    #[doc = r""]
...
impl Deref for TIMER_B3 {
    type Target = timer_b3::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
}
impl core::fmt::Debug for TIMER_B3 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("TIMER_B3").finish()
    }
}
#[doc = "Timer B3"]
pub mod timer_b3;
...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            ...
            PORT_3_4: PORT_3_4::steal(),
            PORT_1_2: PORT_1_2::steal(),
            ADC10: ADC10::steal(),
            SYSTEM_CLOCK: SYSTEM_CLOCK::steal(),
            COMPARATOR_A: COMPARATOR_A::steal(),
            USCI_A0_UART_MODE: USCI_A0_UART_MODE::steal(),
            USCI_A0_SPI_MODE: USCI_A0_SPI_MODE::steal(),
            USCI_B0_I2C_MODE: USCI_B0_I2C_MODE::steal(),
            USCI_B0_SPI_MODE: USCI_B0_SPI_MODE::steal(),
            TLV_CALIBRATION_DATA: TLV_CALIBRATION_DATA::steal(),
            CALIBRATION_DATA: CALIBRATION_DATA::steal(),
            TIMER0_A3: TIMER0_A3::steal(),
            TIMER1_A3: TIMER1_A3::steal(),
            TIMER_B3: TIMER_B3::steal(),
