...
impl W {
    #[doc = "Bit 0 - Low/high Frequency Oscillator Fault Flag"]
    #[inline(always)]
    pub fn lfxt1of(&mut self) -> Lfxt1ofW<Bcsctl3Spec> {
        Lfxt1ofW::new(self, 0)
    }
    #[doc = "Bit 1 - High frequency oscillator 2 fault flag"]
    #[inline(always)]
    pub fn xt2of(&mut self) -> Xt2ofW<Bcsctl3Spec> {
        Xt2ofW::new(self, 1)
    }
    #[doc = "Bits 2:3 - XIN/XOUT Cap 0"]
    #[inline(always)]
    pub fn xcap(&mut self) -> XcapW<Bcsctl3Spec> {
        XcapW::new(self, 2)
    }
    #[doc = "Bits 4:5 - Mode 0 for LFXT1 (XTS = 0)"]
    #[inline(always)]
    pub fn lfxt1s(&mut self) -> Lfxt1sW<Bcsctl3Spec> {
        Lfxt1sW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Mode 0 for XT2"]
    #[inline(always)]
    pub fn xt2s(&mut self) -> Xt2sW<Bcsctl3Spec> {
        Xt2sW::new(self, 6)
    }
}
